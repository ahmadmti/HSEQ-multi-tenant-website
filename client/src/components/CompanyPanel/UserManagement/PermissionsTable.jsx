    ...
    return (
        <div>
            <div className={classes.addButton}>
                <Button variant="contained" color="primary" onClick={() => setModal(true)}>Add</Button>
            </div>
            ...
            <Modal title={'New Assign Privilieg'} open={modal} close={() => setModal(false)}>
                <Grid item md={12} sm={12} xs={12}  >
                    <div className="text-center">
                        <FormControl variant="outlined" style={{ width: '100%' }} className={classes.formControl}>
                            <InputLabel id="demo-mutiple-chip-label">Privilege</InputLabel>
                            <Select
                ...
                <Grid item md={12} sm={12} xs={12}  >
                    <div className="text-center">
                        <Button disabled={permission.length <= 0} onClick={insertNewPermission} variant="contained" color="primary">Submit</Button>
                    </div>
                </Grid>
            </Modal>
        </div>
