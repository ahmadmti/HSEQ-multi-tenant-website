                                ...
                                <Grid container spacing={3} >
                                    ...
                                    <Grid item md={6} sm={6} xs={12} >
                                        <Controller
                                            ...
                                            as={<TextField
                                                ...
                                                label={"Name"} helperText={errors.user_name ? <span>Name is required</span> : null} />}
                                            control={control}
                                            defaultValue=""
                                            rules={{
                                                required: 'Required',
                                    ...
                                    <Grid item md={6} sm={6} xs={12} >
                                        <Controller
                                            ...
                                            as={<TextField
                                                ...
                                                label={'Phone Number'} helperText={errors.phone_number ? <span> Phone Number is required </span> : null} />}
                                            control={control}
                                            defaultValue=""
                                            rules={{
                                                required: 'Required',
                                    ...
                                    <Grid item md={6} sm={6} xs={12} >
                                        <Controller
                                            ...
                                            as={<TextField
                                                ...
                                                helperText={errors.email ? <span>Email is required</span> : null}
                                                fullWidth
                                                label={'Email'}
                                            />}
                                            control={control}
                                    ...
                                    <Grid item md={6} sm={6} xs={12} >
                                        <FormControl error={errors.role_id ? true : false} style={{ width: "100%" }} margin="dense" variant="outlined" className={classes.formControl}>
                                            ...
                                            />
                                            <FormHelperText error>{errors.role_id ? <span>Roles is required</span> : null}</FormHelperText>
                                        </FormControl>
                                    </Grid>
                                    ...
                                    <Grid item md={6} sm={6} xs={12} >
                                        <FormControl error={errors.status ? true : false} style={{ width: "100%" }} margin="dense" variant="outlined" className={classes.formControl}>
                                            ...
                                            />
                                            <FormHelperText error>{errors.status ? <span>Status is required</span> : null}</FormHelperText>
                                        </FormControl>
                                    </Grid>
