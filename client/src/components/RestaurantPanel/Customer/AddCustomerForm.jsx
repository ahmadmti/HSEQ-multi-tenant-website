...
export default function AddCustomerForm(props) {
    ...
    const { register, clearErrors, reset, formState: { isValid }, setValue, control, handleSubmit, errors } = useForm({
        mode: "all",
        reValidateMode: "all",
                                    ...
                                    <Grid item md={6} sm={6} xs={12} >
                                        <Controller
                                            ...
                                            as={<TextField style={{ width: '100%' }} id="name" error={errors.name ? true : false}
                                                ...
                                                // inputProps{{p/attern: '[a-z]'}}
                                                margin="dense" label={t("Name")} variant="outlined" />}
                                            control={control}
                                            defaultValue=""
                                            rules={{
