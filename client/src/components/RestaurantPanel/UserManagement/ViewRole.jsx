    ...
    return (
        <div>
            <div className={classes.addButton}>
                <Button variant="contained" color="primary" onClick={refresh}><ReplayIcon /> {t("Refresh")} </Button>
            </div>
            ...
            <Modal title={t('role_Privilege')} open={permissionModal} close={() => setPermissionModal(false)}>
                <PermissionsTable data={permission} />
            </Modal>


            <Modal title={t('update_role')} open={editRoleModal} close={() => setEditRoleModal(false)}>
                            ...
                            <div className="text-center">
                                <Controller
                                    ...
                                    as={<TextField id="role_name" margin="dense" variant="outlined"
                                        ...
                                        style={{ width: '100%' }} label={t("Role_name")}
                                        helperText={errors.role_name ? <span>{t("Role_name")} {t("required")}</span> : null} />} control={control}
